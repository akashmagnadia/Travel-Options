...
//		vec{ {1, 7}, {2, 8}, {2, 9}, {3, 5}, {5, 8}, {5, 8}, {5, 9}, {6, 12} };
//		vec{ {1, 7}, {2, 8}, {2, 9}, {3, 5}, {5, 8}, {5, 8}, {5, 9} };
		vec{ {2, 9}, {3, 8}, {4, 7}, {5, 6}, {6, 5} };
//		vec{ {3, 5}, {5, 8}, {2, 8}, {1, 7}, {2, 9}, {5, 9}, {6, 12} };
//		vec{ {1, 7}, {2, 8}, {3, 5}, {5, 8}, {6, 12} };
	...
	if (options_p->is_pareto_sorted())
		std::cout << "PARETO_SORTED!" << std::endl;

	//testing
//	cout << "Before" << endl;
//	options_p->display();

	if (options_p->insert_sorted(1.0, 10.0))
...
//	options_p->display();
	...
	cout << "Before" << endl;
	options_p->display();
	if (options_p->insert_pareto_sorted(7.0, 4.0))
